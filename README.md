...
##### Seção 4: introdução ao desenvolimento Web com Node.js
...
- [x] 5.3 - Arquitetura de Software: Camanda Controller
- [ ] 5.4 - Projeto - Store Manager

##### Seção 6: Node.js: ORM e Autenticação
- [x] 6.1 - Interface da aplicação com banco de dados
- [x] 6.2 - Association 1:1 e 1:N
- [x] 6.3 - Assciation N:N e Transactions
- [ ] 6.4 - JWT (JSON e Web Token)
- [ ] 6.5 - Projeto - API de Blogs

##### Seção 7: Masterclass: Implantação de Aplicações na Nuvem
- [ ] 7.1 - Infraestrutura: Deply com Railway
